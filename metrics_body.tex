...
Предположим, что на самом деле верна альтернативная гипотеза, $y_i = 2 + b_i + u_i$,
...
Предположим, что на самом деле верна альтернативная гипотеза, $y_i = 2 + a_i + u_i$,
Регрессоры $a_i$, $b_i$ и ошибки $u_i$ независимы и имеют стандартное нормальное распределение.
...
Assume that the alternative is true,  $y_i = 2 + b_i + u_i$,
...
Assume that the alternative is true,  $y_i = 2 + a_i + u_i$,
Regressors $a_i$, $b_i$ and random errors $u_i$ are independent and have standard normal distribution.
