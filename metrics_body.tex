...
\begin{problem}
  \trru{Есть два совершенно одинаковых предварительно стандартизированных регрессоров $x$, а зависимая переменная $y$ предварительно центрирована.
  ...
  \tren{We have two absolutely identical preliminary standardized regressors $x$. 
