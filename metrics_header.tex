...
% \setmathfont[Scale=MatchUppercase]{libertinusmath-regular.otf} % does not work??
% from https://ctan.org/tex-archive/fonts/libertine
...
\title{\trru{Заметки к семинарам по метрике} \tren{Econometrics: class notes}}    
