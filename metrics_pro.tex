...
Он нарисовал три точки на плоскости $(x, y)$ так, что
...
\begin{problem}
Винни-Пух знает, что мёд бывает правильный, $honey_i=1$, и неправильный, $honey_i=0$. 
Пчёлы также бывают правильные, $bee_i=1$, и неправильные, $bee_i=0$. 
...
\begin{problem}
  ...
  А на самом деле $y_i = \beta_1 + \beta_2 x_i + \beta_3 x_i^3 + u_i$, причём $x_i \sim \cN (0; 1)$ и ошибки $u_i|x_i \sim \cN(0; \sigma^2)$. 
...
\begin{problem}
  ...
  \begin{enumerate}
    \item $\E(u_1|x_1)=0$, но $\E(u_1|x_1, x_2) \neq 0$;
    \item $\E(u_1|x_1)\neq 0$, но $\E(u_1|x_1, x_2) = 0$.
  \end{enumerate}
\begin{sol}
  \begin{enumerate}
    \item Например, можно взять $u_1=x_2$, и все величины $\cN(0;1)$.
    \item Невозможно, в силу $\E(u_1|x_1) = \E(\E(u_1|x_1, x_2)|x_1)$.
  \end{enumerate}
